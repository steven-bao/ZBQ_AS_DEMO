 ...
 * 而不管是在画红圈区域上下滑动，还是在按钮上滑动，都会调用父View的dispatchTouchEvent()方法。
 * OK，那我们就可以将弹性效果放到dispatchTouchEvent()中，并加上上下滑动的判断，
 */
public class BounceScrollViewDemo extends ScrollView {
    ...
    public BounceScrollViewDemo(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
