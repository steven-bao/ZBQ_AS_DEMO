...
public class PullRefreshExpandActivityDemo extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pull_expandListView = (PullToRefreshExpandableListView) findViewById(R.id.pull_expandListView);
    ...
    public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
        Toast.makeText(PullRefreshExpandActivityDemo.this, arms[groupPosition][childPosition] + "", Toast.LENGTH_SHORT).show();
        return false;
    }
    @Override
    ...
    private void onRefresh() {
        pull_expandListView.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ExpandableListView>() {
            ...
            public void onPullDownToRefresh(PullToRefreshBase<ExpandableListView> refreshView) {
                ...
                Toast.makeText(PullRefreshExpandActivityDemo.this, "下拉刷新", Toast.LENGTH_SHORT).show();
            }
            ...
            public void onPullUpToRefresh(PullToRefreshBase<ExpandableListView> refreshView) {
                ...
                Toast.makeText(PullRefreshExpandActivityDemo.this, "上拉加载", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public class ExpandableListAdapter extends BaseExpandableListAdapter {
        ...
        public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
            // 为视图对象指定布局
            convertView = View.inflate(PullRefreshExpandActivityDemo.this,
